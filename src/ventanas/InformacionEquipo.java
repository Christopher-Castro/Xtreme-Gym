...
public class InformacionEquipo extends javax.swing.JFrame {
    ...
    public InformacionEquipo() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                jDateChooser1.setDate(rs.getDate("fecha_inicio"));
                jDateChooser2.setDate(rs.getDate("fecha_fin"));
    ...
    private void initComponents() {
        ...
        jLabel_Titulo.setText("Información de servicio");
        ...
        getContentPane().add(jLabel_Nombre7, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 60, -1, -1));
        ...
        txt_ultima_Modificacion.setBackground(new java.awt.Color(153, 153, 153));
        ...
        getContentPane().add(cmb_estatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 80, -1, -1));
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        ...
        if (validacion == 0) {
            ...
            try {
                Connection cn = Conexion.conectar();
                PreparedStatement pst = cn.prepareStatement(
 "update equipos set tipo_equipo=?, marca=?, observaciones=?, estatus=?, ultima_modificacion=?, fecha_inicio=?, fecha_fin=? "
